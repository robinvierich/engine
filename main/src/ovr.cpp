...
// Increment to use next texture, just before writing
    ...
    int eyeViewportX = layer.Viewport[pTextureSet->CurrentIndex].Pos.x;
    int eyeViewportY = layer.Viewport[pTextureSet->CurrentIndex].Pos.y;
    GLsizei eyeViewportWidth = layer.Viewport[pTextureSet->CurrentIndex].Size.w;
    GLsizei eyeViewportHeight = layer.Viewport[pTextureSet->CurrentIndex].Size.h;
